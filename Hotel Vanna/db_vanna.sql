...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2022 pada 08.04
...
(3, 'Gym', 'Bagi anda yang suka berolahraga, Kami manajemen Hotel Vanna juga Menyediakan fasilitas olahraga dan gym, sehingga client juga bisa berolahraga di hotel tanpa harus capek pergi keluar sekedar mencari tempat GYM, dan juga berolahraga di GYM hotel mercure juga sangat menyenangkan karena sambil berolahraga juga bisa sambil menikmati sunset di Penghujung senja.', 'gym.jpg'),
...
(5, 'Spa', 'Hotel Vanna Menyediakan fasilitas SPA bagi para perempuan yang ingin tampil lebih cantik dan memanjakan diri mereka, selain itu petugas SPA juga sangat ramah serta produk yang pakai di SPA Hotel Mercuredi bawah perlindungan dokter kecantikan, jadi di jamin aman untuk kulit client.', 'spa.jpg'),
...
(17, 6, 'nissa', 'nurholisahnissa@gmail.com', 'nissa', '083824689138', '2022-05-21', '2022-05-24', 1, 'cek in');
